...
// SQL dotaz
$query = "SELECT SPEED, SPEED2, RPMS, VOLT, TEMP, FUEL FROM DATA ORDER BY TIME DESC LIMIT 1";
...
<body>
    <div class="container">
        ...
        <div class="block">
            <div class="value"><?php echo isset($data['FUEL']) ? $data['FUEL'] : '-'; ?></div>
            <div class="label">IDK</div>
        </div>
        <script>
