...
<div id="container">
        <div id="top">
            <h1>Grafy z databáze Volvo V40</h1>
        </div>
        <form method="post">
        ...
        <h2>Spotřeba</h2>
        <div class="chart" id="chart_fuel"></div>
</div>
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "SELECT TIME, TEMP, SPEED, SPEED2, RPMS, VOLT, FUEL FROM DATA WHERE TIME BETWEEN '$start' AND '$end'";
        } else {
            $sql = "SELECT TIME, TEMP, SPEED, SPEED2, RPMS, VOLT, FUEL FROM DATA ORDER BY TIME ASC LIMIT 25";
        }
    ...
    <script>
        ...
        createChart("chart_fuel", ["FUEL"], ["FUEL"]);
